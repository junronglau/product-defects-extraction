...
class DataLoader:
    def __init__(self, config):
        ...
        self.test_df = self.load_testing_data(test_data_path)
    ...
    def load_testing_data(self, path):
        test_df = self.load_data(path)
        test_df.loc[test_df['has_defect'] == 0, 'has_defect'] = -1
        return test_df
    ...
    def load_unlabelled_training_data(self):
        ...
        unlabelled_train_df['has_defect'] = -1
